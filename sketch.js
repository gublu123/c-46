...
function score()
{
    if((arrow1.body.position.y<370 && arrow1.body.position.y>=325) && arrow1.body.velocity.y<1 && arrow1.body.position.x>260){
        score1=score1+2;
        arrow1.body.position.x = 258;
        console.log(score1);
    }
    if((arrow1.body.position.y<325 && arrow1.body.position.y>=290) && arrow1.body.velocity.y<1 && arrow1.body.position.x>260){
        score1=score1+3;
        arrow1.body.position.x = 258;
       console.log(score1);
       
    }
    if((arrow1.body.position.y<260 && arrow1.body.position.y>=230) && arrow1.body.velocity.y<1 && arrow1.body.position.x>260){
        score1=score1+5;
        arrow1.body.position.x = 258;
        console.log(score1);
       
    }
    if((arrow1.body.position.y<230 && arrow1.body.position.y>=170) && arrow1.body.velocity.y<1 && arrow1.body.position.x>260){
        score1=score1+10;
        arrow1.body.position.x = 258;
        console.log(score1);
